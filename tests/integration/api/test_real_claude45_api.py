...
class TestRealClaude45API:
    ...
    def _call_claude45_api_not_stream(self, **kwargs):
        """Helper method to call Claude 4.5 API (non-streaming only)."""
        # Ensure streaming is disabled for this method
        if 'stream' in kwargs:
            del kwargs['stream']

        default_params = {
            'model': 'openai/claude-4.5-sonnet',
    ...
    def _call_claude45_api_streaming(self, **kwargs):
        """Helper method to call Claude 4.5 API with streaming."""
        default_params = {
            'model': 'openai/claude-4.5-sonnet',
            'api_base': self.base_url,
            'api_key': self.api_key,
    ...
    def test_claude45_basic_completion(self):
        """Test basic Claude 4.5 completion with a simple prompt."""
        response = self._call_claude45_api_not_stream(
    ...
    def test_claude45_with_system_message(self):
    ...
    def test_claude45_streaming_completion(self):
        """Test Claude 4.5 completion with streaming enabled."""
        response_stream = self._call_claude45_api_streaming(
    ...
    def test_claude45_multi_turn_conversation(self):
    ...
    def test_claude45_with_low_temperature(self):
    ...
    def test_claude45_with_max_tokens_limit(self):
        """Test Claude 4.5 with max_tokens parameter."""
        response = self._call_claude45_api_not_stream(
